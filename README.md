Les données utilisées pour ce projet ont été prise de Kaggle. <br>
https://www.kaggle.com/datasets/abdallahwagih/mall-customers-segmentation <br>
Mall_Customers.csv 

Le but de ce projet était d'analyser les données sur les clients d'un centre commercial,
séparer les clients en plusieurs groupes et déterminer quel groupe est à prioriser dans la stratégie marketing du centre commercial.

Le fichier Mall_Customer.csv contient les informations suivantes sur les clients: <br>
1. CustomerID (unique à chaque client)
2. Genre (Homme ou Femme)
3. Age (Nombre entier)
4. Annual Income (k$) (Salaire annuel du client en milliers de dollars, Nombre entier)
5. Spending Score (1-100) (Un score assigné par le centre commercial déterminé par les habitudes d'achats, Nombre entier)
